...
```text
input รับเป็นตัวเลขไปเรื่อยๆจนกว่าจะเจอ-1 outputเป็นช่วงของเลขที่ตต่อเนื่องกัน
```
...
```text
รับinputเป็นลูปแล้วเขียนลูปของช่วงตัวเลข
```
...
```text
รับinputเป็นลูป  แล้วเขียนลูปของช่วงตัวเลขถ้าตัวเลข+1ชตัวต่อไปจะข้ามไปจนกว่าจะเจอตัวสุดท้ายของช่วงนั้นแล้วappenเข้าไปในลิสต์ แล้วถ้าไม่มีช่วงก็appendแต่ตัวนั้น แล้วก็เขียนoutput
```
