...
```text
inputรับจำนวน และความยาวคอ outputจำนวนตัวที่ไม่โดนแย่งกิน
```
...
```text
รับinput แล้วเขียนลูปว่าตัวไหนไม่โดนแย่งกินเพราะคอยาวกว่าเพื่อนข้างๆตัวทั้ง2ฝั่ง
```
...
```text
รับinput แล้วเขียนลูปว่าตัวไหนไม่โดนแย่งกินเพราะคอยาวกว่าเพื่อนข้างๆตัวทั้ง2ฝั่ง แต่เขียนแยกกรณีเพราะติดindex error
```
