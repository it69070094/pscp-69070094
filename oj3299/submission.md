...
```text
รับinputเข้ามาเป็นแถบกับช่องสุดท้าย outputเป็นช่องสุดท้ายอยู่แถวไหน
```
...
```text
ประยุกต์สูตรอนุกรมด้วยการคูณlเข้าไปในทุกตัวแปรแล้วเขียนลูปไปเรื่อยๆ
```
