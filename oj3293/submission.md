...
```text
input เป็นstr5บรรทัด outputเป็น5บรรทัดที่ใส่กรอบแล้ว
```
...
```text
รับinputเข้ามาแล้วบรรทัดแรกเป็น"*"เท่ากับตัวอักษรที่มากที่สุด+4 แล้วแต่ละบรรทัดก็จะพิมพ์ " " ตามตัวอักษรที่มากที่สุดแล้วใส่"*"หน้าหลัง
```
