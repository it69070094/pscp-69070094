...
```text
inputทั้งสองอันคือสแม่สีสองสี outputคือสีที่เกิดจากการผสมโดยแม่สีสองสี
```
...
```text
Step 1:ดูลายละเอียดของโจทย์
Step 2:ดูinput และ output จากตัวอย่าง
Step 3:ดูตารางผสมสีที่โจทย์ให้มาและเขียนโค้ดตามนั้น
```
...
```text
ใส่inputเป็นแม่สีสองสีเข้ามาและเขียนโค้ดสีที่ผสมได้หลังจากนั้นผลลัพย์จะเป็นสีที่ผสมออกมา หรือถ้าไม่ใส่สีที่กำหนดไว้ outputจะเป็นerror
```
