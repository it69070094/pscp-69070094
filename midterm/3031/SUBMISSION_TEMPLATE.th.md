...
```text
inputเป็นค่าของพื้นที่ก่รขย่ยของหมึกต่อวิ และจำนวนคำร้อง แล้วบรรทัดต่อๆจากนั้นเป็นพิกัดบ้านคน outputเป็นเวลาที่บ้านจะโดนหมึกท่วม
```
...
```text
Step 1:เขียมสมการหาระยะทางจากจุดเริ่มต้น
Step 2:เขียมสมการหาเวลาที่จะโดนหมึกท่วมบ้าน
Step 3:เขียนoutputออกมาให้เท่ากับที่ได้รับinputเข้ามา
```
...
```text
เริ่มจากรับค่าว่าหมึกขยายกี่วิและรับค่าคำร้องว่ามีกี่คน จากนั้นเขียนลูปรับค่าพิกัดบ้านตามคำร้องที่ได้รับเข้ามา แล้วคิดหาพิกัดของบ้านจากจุด0,0เพื่อนำไปใช้หาเวลาต่อต้องใช้ค่าpiเนื่องจากหมึกขยายเป็นวงกลม แล้วค่อยเขียนoutputออกมา
```
