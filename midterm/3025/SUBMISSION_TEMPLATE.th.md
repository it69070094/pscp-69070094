...
```
input เข้ามาเป็นวันและเดือน และถ้าเลยวันที่21ของเดือนที่หาร3ลงตัวไปแล้วจะเป็นอีกฤดูการนึง output เป็นฤดูการ
---
...
Step 2:เขียนโค้ดรับinputแล้วเขียนเงื่อนไขทั้งหมด
Step 3:เขียนoutput
```
...
```text
เขียนเป็นการคัดกรองแรกจากเดือนว่าเป็นเดือนที่เท่าไหร่แล้วนำมากรองอีกทีว่าเป็นวันที่21ของเดือนที่หาร3ลงตัวหรือไม่
```
