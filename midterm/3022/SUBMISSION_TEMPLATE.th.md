...
```text
input 1.เป็นค่าอุณหภูมิ 2.หน่วยของค่าอุณหภูมิ 3.หน่วยที่ต้องการแปลงไป outputเป็นอุณหภูมิที่แปลงแล้ว
```
...
```text
รับค่าinputเข้ามาแล้วแปลงค่าอุณหภูมิเป็นองศาC ยกเว้นค่าืี่ได้รับเข้ามาเป็นองศาCอยู่แล้ว แล้วก็นำไปแปลงเป็นค่าอุณภูมิอื่นตามเงื่อนไข
```
