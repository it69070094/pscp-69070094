...
```text
inputเป็นคะแนนรวมและค่าสูงสุด outputเป็นความเป็นไปได้ที่จะมีหน้าม้ามาอวยมั้ย
```
...
```text
Step 1:อ่านเงื่อนไขของโจทย์
Step 2:เขียมเงื่อนไขตามที่เขาต้องการออกมา
Step 3:เขียนoutput
```
...
```text
เริ่มจากเขียมสมการตั้งต้นว่าค่าที่น้อยที่สุดที่เป็นไปได้ควรจะเป็นเท่าไหร่(ค่ารวม - (2 * ค่ามากที่สุด)) จากนั้นเขียนเงื่อนไขไม่ให้ค่าที่น้อยที่สุดต่ำกว่า0ได้ แล้วเขียนตามเงื่อนไขที่โจทย์ให้มา
```
