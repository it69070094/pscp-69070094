...
```
input เป็นตัวอักษร 5 ตัว และต้องการให้ output คือตัวอักษรที่กลับหลัง
```
...
```text
Step 1:อ่านว่าโจทย์ต้องการอะไร
Step 2:ลองด฿ว่าตัวอย่างtestcaseเป็นแบบไหน
Step 3:ลองเขียนโค้ด เริ่มจาก input แล้วค่อยลองเเขียนoutputตามตัวอย่างทีละบรรทัด
```
...
```
รับตัวอักษรเข้ามาจากinputและนำมาเขียนกลับหลังด้วยโค้ด[::-1]
```
---
...
```text
เป็นชื่อของหนูแปลเป็นภาษาไทยและมี5ตัวอักษรพอดี
```
