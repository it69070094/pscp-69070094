...
```text
inputรับค่าตัวเลขเข้ามา outputเป็นทุกๆจำนวนที่หาร10ได้จนถึงจำนวนนั้น
```
...
```text
Step 1:อ่านโจทย์ให้เข้าใจ
Step 2:เขียนโค้ดตามเงื่อนไขของโจทย์ หาจำนวนที่หาร10ได้จนถึงจำนวนที่ได้รับเข้ามา
...
```text
รับค่าจำนวนสุดท้ายเข้ามา แล้วนำไปหารไม่เอาเศษด้วย10เพื่อหาว่าจะมีกี่ตัวที่หาร10ได้แล้วนำเข้าไปใส่ในลิสต์เพื่อกลับหน้าเป็นหลังแล้วปริ้นออกมาด้วยคำสั่ง * เพื่อที่จะเอาoutputแค่ตัวเลข
```
