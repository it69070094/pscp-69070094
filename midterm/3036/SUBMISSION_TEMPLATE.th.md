...
```text
input เป็นห้องที่อยู่ในตอนนี้ outputเป็นกำแพงที่ต้องพังเพื่อไปให้ถึงห้องที่1
```
...
Step 2:เขียนเงื่อไขห้องที่เป็นเลขคู่
Step 3:เขียนเงื่อนไขห้องที่เป็นเลขคี่
```
...
```text
พอได้รับเลขห้องเข้ามาให้นำไปหาsqrtแล้วใช้ceilเพื่อปัดค่าทศนิยมขึ้นทุกกรณี แล้วเขียนเงื่อนไขเป็นชั้นเลขคู่หรือเลขคี่แล้วเขียนเงื่อนไขแยกห้องเลขคู่เลขคี่ของแต่ละชั้น 
```
