...
```text
input เป็นราคาอาหาร output เป็นราคาอาหารที่คิดภาษีและค่าบริการพร้อมแล้ว
```
...
```text
Step 1:อ่านลายละเอียดโจทย์
Step 2:อ่านinput outputของตัวอย่างที่ให้มา
Step 3:เขียนโค้ดตามลายละเอียดและเงื่อไขทั้งหมด
```
...
```text
ได้รับค่าinputเป็นราคาอาหาร และคิดคำนวนค่าภาษีและค่าบริการตามเงื่อนไขที่โจทย์ให้มา outputเป็นค่าที่ทุกอย่างบวกรวมกันแล้ว
```
