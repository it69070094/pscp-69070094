...
```text
input เป็นค่าสี2สี outputเป็นค่าสีที่ผสมกัน
```
...
```text
รับค่าเข้ามาบวกกันหารสองแล้วเอาค่าหารสองเป็นoutput
```
...
```text
เขียนสูตร(c1+c2)//2ไว้เป็นfunctionแรก เขียนfunction2เป็นค่าของrgb แล้วรับinputเข้ามา2บรรทัดแล้วsplitค่าออกมาแล้วก็ดึงfunction2ลงมาใช้
```
