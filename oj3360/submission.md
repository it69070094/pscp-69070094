...
```text
input เป็นความกว้างยางของขนมปังและแกนxyมีใบมีดกี่ใบ และพิกัดของใบมีดดอยู่ตรงไหน output เป็นขนมปังชิ้นใหญืที่สุด2ชิ้น
```
...
```text
รับinputแล้วหาพื้นที่ของขนมปัง
```
...
```text
รับค่าเข้ามาแล้ว เอาพิกัดไปใส่ลูปลบกันเพื่อหาของกว้ายาวของขนมปังที่โดนตัดออกมาแล้ว แล้วเอาไปคูณกันทุกตัวแล้วเรียงจากมากไปน้อย
```
